@section('site_title', formatTitle([__('New'), __('Album'), config('app.name')]))
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section class="space-y-6">
                        ...
                        @endphp
                        <form enctype="multipart/form-data" method="post" action="{{ route('albums.new') }}"
                                ...
                                <div class="grow space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <x-input-select-album id="i-production" name="pid" class="mt-1 block w-full"
                                            :options="$production_list" :selected="old('pid')" autofocus />
