@section('site_title', formatTitle([__('New'), __('Production'), config('app.name')]))
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div class="max-w-xl">
                    <section class="space-y-6">
                        ...
                        <form enctype="multipart/form-data" method="post" action="{{ route('productions.new') }}"
                                ...
                                <div class="grow space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="i-slug" name="slug" type="text"
                                            class="mt-1 block w-full" :value="old('slug')" required autofocus />
                                        <x-input-error class="mt-2" :messages="$errors->get('slug')" />
                                    </div>

                                    <div>
                                        <x-input-label for="i-status" :value="__('Status')" />
                                        <x-input-select id="i-status" name="public" class="mt-1 block w-full" :options="[0 => __('Unpublic'), 1 => __('Public')]"
                                            :selected="old('public', 1)" autofocus />
