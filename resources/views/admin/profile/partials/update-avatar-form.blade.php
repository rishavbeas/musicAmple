...
<script>
    function previewImage() {
        return {
            ...
            init() {
                this.imageUrl = "{{ url('/') }}/uploads/avatars/{{ $user->image }}",
